...
<div class="module-header">
    ...
    <button class="btn-primary" onclick="openTestimonialModal()">+ Nouvel Avis</button>
</div>
...
<!-- Modal -->
<div class="modal" id="testi-modal">
    <div class="modal-content" style="max-width: 800px;">
        ...
        <form id="testi-form" onsubmit="saveTestimonial(event)">
            ...
            <div style="margin-top:20px; display:flex; justify-content:flex-end; gap:10px;">
                <button type="button" class="btn-secondary" onclick="closeTestimonialModal()">Annuler</button>
            ...
            tbody.innerHTML += `
                <tr>
                    ...
                    <td class="action-cell">
                        <button class="btn-icon" onclick="editTestimonial(${t.id})" title="Modifier">✏️</button>
                        <button class="btn-icon" style="color:var(--danger)" onclick="deleteTestimonial(${t.id})" title="Supprimer">🗑️</button>
                    </td>
                </tr>
            `;
        });
